...
# ----------------------------------------
# If pll_2clk is one of several IP cores in your
...
# ----------------------------------------
# ACDS 25.1 1129 win32 2026.07.17.14:05:48
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_2clk.vho"
}
